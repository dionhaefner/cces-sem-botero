...
# SETS AVAILABLE MODEL PARAMETERS, THEIR TYPE AND DEFAULT VALUE
_PARAMETERS = [
			...
			("mu",float,1E-3,"mutation rate of each gene"),
			...
			("populations",int,10,"number of identical populations per run"),
...
for key in ["R","P","A","B","O"]:
	parser.add_argument("--"+key,type=int,help="Overrides parameter {0} for all environments".format(key))
